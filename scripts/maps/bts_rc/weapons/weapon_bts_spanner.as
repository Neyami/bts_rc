...
namespace weapon_bts_spanner
{
	...
	class weapon_bts_spanner : ScriptBasePlayerWeaponEntity, bts_rc_base_weapon, bts_rc_base_melee
	{
        ...
        void ItemPostFrame()
        {
            ...
            if( m_pPlayer.pev.sequence == 21 || m_pPlayer.pev.sequence == 24 ) // ref_shoot_crowbar, crouch_shoot_crowbar
                m_pPlayer.pev.framerate = 1.5f;
        }
		...
		bool Deploy()
		{
			return bts_deploy("models/bts_rc/weapons/v_spanner.mdl", "models/bts_rc/weapons/p_spanner.mdl", DRAW, "crowbar", 1, 0.5f);
		}
