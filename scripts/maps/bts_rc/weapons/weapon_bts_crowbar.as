    ...
    class weapon_bts_crowbar : ScriptBasePlayerWeaponEntity, bts_rc_base_weapon, bts_rc_base_melee
    {
		...
		private bool Shove()
		{
            ...
            else
            {
                ...
                if( self.m_flNextPrimaryAttack + 1.0f < g_Engine.time )
                    pEntity.TraceAttack( m_pPlayer.pev, DAMAGE2, g_Engine.v_forward, tr, DMG_LAUNCH ); // first swing does full damage
                else
                    pEntity.TraceAttack( m_pPlayer.pev, DAMAGE2 * 0.5f, g_Engine.v_forward, tr, DMG_LAUNCH ); // subsequent swings do 50% (Changed -Sniper) (Half)
