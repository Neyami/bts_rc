...
namespace weapon_bts_m4sd
{
    ...
    class weapon_bts_m4sd : ScriptBasePlayerWeaponEntity, bts_rc_base_weapon
    {
        ...
        void PrimaryAttack()
        {
			...
			g_SoundSystem.EmitSoundDyn( m_pPlayer.edict(), CHAN_ITEM, "bts_rc/weapons/m4_fire1.wav", 0.3f , ATTN_NORM, 0, 98 + Math.RandomLong( 0, 3 ) );
            ...
            self.m_flNextPrimaryAttack = self.m_flNextSecondaryAttack = g_Engine.time + ( m_iFireMode != SEMI ? 0.104f : 0.095f );
...
*/
        ...
        void SecondaryAttack()
        {
			...
			self.SendWeaponAnim( SEMIE, 0, pev.body );
